...
#
    ...
    # Logs files
        ...
        # Execution logs
        LOGFILE_NAME_SINGLE=REMOTE_STREAM_SINGLE_LOG_${HOSTNAME}_${timestamp}.log
        LOGFILE_NAME_MULTI=REMOTE_STREAM_MULTI_LOG_${HOSTNAME}_${timestamp}.log
        LOGFILE_NAME_MPI=REMOTE_STREAM_MPI_LOG_${HOSTNAME}_${timestamp}.log

        # Data logs
        LOGFILE_NAME_SINGLE_DATA=REMOTE_STREAM_SINGLE_DATA_LOG_${HOSTNAME}_${timestamp}.log
        LOGFILE_NAME_MULTI_DATA=REMOTE_STREAM_MULTI_DATA_LOG_${HOSTNAME}_${timestamp}.log
        LOGFILE_NAME_MPI_DATA=REMOTE_STREAM_MPI_DATA_LOG_${HOSTNAME}_${timestamp}.log
